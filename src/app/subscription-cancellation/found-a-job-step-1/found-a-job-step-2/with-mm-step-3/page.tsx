      ...
      <div className="mx-auto w-full md:max-w-5xl bg-white md:rounded-3xl md:shadow-xl md:border md:border-neutral-200 md:my-10">
        ...
        <div className="grid md:grid-cols-2 gap-0">
          ...
          <section className="px-4 md:px-6 py-6 md:py-8 flex flex-col">
            <h1 className="text-[26px] leading-8 md:text-2xl md:leading-tight font-semibold text-neutral-900">
              <span className="block md:whitespace-nowrap">
                We helped you land the job,
              </span>
              <span className="block md:whitespace-nowrap">
                now let’s help you secure your visa.
              </span>
            </h1>
        ...
        : "bg-neutral-100 text-neutral-400 cursor-not-allowed"
                ...
                onClick={async () => {
                  ...
                  if (success) {
                    ...
                    //rollback on failure
                    //check if prev valus are not null
